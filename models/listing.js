...
const listingSchema = new Schema({
  ...
  category: {
    type: String,
    enum: ["Trending", "Rooms", "Iconic cities", "Mountains", "Castels", "Amazing Pools", "Camping", "Farms", "Beaches", "Pet-Friendly", "Hiking", "City Breaks", "Skiing", "Family", "Business", "Historic", "Nightlife"]
  }
});
